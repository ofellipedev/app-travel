...
$pdo = db_connect();
$sql = $pdo->query("SELECT * FROM users WHERE name_user LIKE '%$search%'");
$count = $sql->rowCount();
...
<head>
  ...
  <title>APP Travel | Dashboard</title>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                       <a href="../profile.php?id_user=<?=$user['id_user']; ?>" class="btn btn-info">Ver</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
